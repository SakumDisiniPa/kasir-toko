            ...
            <div class="card-body p-3 p-md-4">
                ...
                <div class="form-group">
                    ...
                    <x-input name="nama" type="text" :value="$pelanggan->nama" 
                             class="form-control-lg" placeholder="Masukkan nama lengkap" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <x-textarea name="alamat" :value="$pelanggan->alamat" 
                                class="form-control-lg" placeholder="Masukkan alamat lengkap" rows="3" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <x-input name="nomor_tlp" type="text" :value="$pelanggan->nomor_tlp" 
                             class="form-control-lg" placeholder="Contoh: 08123456789" />
                </div>
            </div>
