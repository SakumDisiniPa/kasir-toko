...
<div class="row justify-content-center">
  <div class="col-12 col-md-8 col-lg-6 col-xl-4">
    <form method="POST" class="card card-orange card-outline shadow" action="{{ route('user.update', ['user' => $user->id]) }}">
      ...
      <div class="card-body p-3 p-md-4">
        ...
        <div class="form-group">
          ...
          <x-select name="role" :value="$user->role" class="form-control-lg"
