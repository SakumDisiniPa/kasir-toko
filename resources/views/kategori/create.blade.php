...
<div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6 col-xl-4">
        <form method="POST" action="{{ route('kategori.store') }}" class="card card-orange card-outline shadow">
            ...
            <div class="card-body p-3 p-md-4">
                ...
                <div class="form-group">
                    ...
                    <x-input name="nama_kategori" type="text" class="form-control-lg" placeholder="Masukkan nama kategori" />
                </div>
            </div>
